...
type ChannelType struct {
	...
	StorageFormat     string                  `xml:"http://www.fdsn.org/xml/station/1 StorageFormat,omitempty"`
...
type CoefficientsType struct {
	...
	Numerator              []FloatType            `xml:"http://www.fdsn.org/xml/station/1 Numerator,omitempty"`
	Denominator            []FloatType            `xml:"http://www.fdsn.org/xml/station/1 Denominator,omitempty"`
	ResourceId             string                 `xml:"resourceId,attr,omitempty"`
	Name                   string                 `xml:"name,attr,omitempty"`
}
...
type LogType struct {
	Entry []CommentType `xml:"http://www.fdsn.org/xml/station/1 Entry"`
}
...
type ResponseStageType struct {
	...
	StageGain    GainType         `xml:"http://www.fdsn.org/xml/station/1 StageGain"`
...
type StationType struct {
	...
	Equipment              []EquipmentType         `xml:"http://www.fdsn.org/xml/station/1 Equipment,omitempty"`
	Operator               []Operator              `xml:"http://www.fdsn.org/xml/station/1 Operator,omitempty"`
	CreationDate           time.Time               `xml:"http://www.fdsn.org/xml/station/1 CreationDate"`
...
func (t *StationType) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	var layout struct {
		*T
		CreationDate    *xsdDateTime `xml:"http://www.fdsn.org/xml/station/1 CreationDate"`
