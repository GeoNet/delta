		...
		Dataloggers: []Datalogger{
			{
				...
				StorageFormat:  "Steim1",
				ClockDrift:     0.0001,
				FilterList:     []string{"Nanometrics_Centaur-10-Linear"},
				Stages: []ResponseStage{
					{
						Type:   "a2d",
						Lookup: "A2D",
						Filter: "Nanometrics_Centaur-10-Linear",
						StageSet: A2D{
							Name:  "A2D",
							Code:  PZFunctionLaplaceZTransform,
							Type:  "Digital (Z-transform).",
						...
						Type:   "fir",
						Lookup: "Nanometrics_213_20_Linear",
						Filter: "Nanometrics_Centaur-10-Linear",
						StageSet: FIR{
							Name:       "Nanometrics_213_20_Linear",
							Causal:     false,
							Symmetry:   SymmetryNone,
							Decimation: 20,
							Gain:       1,
						...
						Type:   "fir",
						Lookup: "Nanometrics_177_15_Linear",
						Filter: "Nanometrics_Centaur-10-Linear",
						StageSet: FIR{
							Name:       "Nanometrics_177_15_Linear",
							Causal:     false,
							Symmetry:   SymmetryNone,
							Decimation: 15,
							Gain:       1,
				...
				Stages: []ResponseStage{
					{
						...
						StageSet: PAZ{
							...
							Poles: []complex128{(-0.036614 + 0.037059i), (-0.036614 - 0.037059i), (-32.55 + 0i), (-142 + 0i), (-364 + 404i), (-364 - 404i), (-1260 + 0i), (-4900 + 5200i), (-4900 - 5200i), (-7100 + 1700i), (-7100 - 1700i)},
							Zeros: []complex128{(0 + 0i), (0 + 0i), (-31.63 + 0i), (-160 + 0i), (-340 + 0i), (-3177 + 0i)},
						},
						Frequency:  1,
						SampleRate: 0,
						Decimate:   0,
