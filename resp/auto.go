...
var DataloggerModels map[string]DataloggerModel = map[string]DataloggerModel{
	...
	"GSM-19": {
		Name:         "GSM-19",
		Type:         "Magnetometer",
		Description:  "High Precision Overhauser Magnetometer",
...
var SensorModels map[string]SensorModel = map[string]SensorModel{
	...
	"GSM-19": {
		Name:         "GSM-19",
		Type:         "High Precision Overhauser Magnetometer",
		Description:  "GSM-19",
		Manufacturer: "GEM Systems",
		Vendor:       "",
		Components:   []SensorComponent{{Azimuth: 0, Dip: 0}},
...
var Responses []Response = []Response{
	{
		...
		Name: "GEM Systems Overhauser Magnetometers",
		Sensors: []Sensor{
			{
				SensorList: []string{"GSM-19"},
				FilterList: []string{},
				Stages:     []ResponseStage{},
				Channels:   "F",
				Reversed:   false,
