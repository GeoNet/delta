...
var StateOfHealth []Response = []Response{
	{
		Name:    "clock drift",
		Sensors: []Sensor{},
		Dataloggers: []Datalogger{
		...
		Dataloggers: []Datalogger{
			{
				DataloggerList: []string{"ETNA 2", "Q330/3", "Q330/6", "Q330S/3", "Q330S/6", "Q330HR/6", "Q330HRS/6"},
				Type:           "HC",
				Label:          "LC",
				Channels:       "Q",
				SampleRate:     1,
		...
		Sensors: []Sensor{
			{
				SensorList: []string{"SOH-AMPMETER"},
			},
		},
		Dataloggers: []Datalogger{
			{
				...
				DataloggerList: []string{"Q330/3", "Q330/6", "Q330S/3", "Q330S/6", "Q330HR/6", "Q330HRS/6"},
				Type:           "HC",
				Label:          "VE",
				Channels:       "C",
				SampleRate:     0.1,
		...
		Sensors: []Sensor{
			{
				SensorList: []string{"SOH-THERMOMETER"},
			},
		},
		Dataloggers: []Datalogger{
			{
		...
		Sensors: []Sensor{
			{
				SensorList: []string{"SOH-VOLTMETER"},
			},
		},
		Dataloggers: []Datalogger{
			{
