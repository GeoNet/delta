		...
		Sensors: []Sensor{
			{
				...
				SensorList: []string{"4.5 Hz Duke Malin Seismometer"},
				FilterList: []string{"4.5_Hz_Duke_Malin_Seismometer"},
				Stages: []ResponseStage{
					{
						Type:   "paz",
						Lookup: "MALIN_4.5",
						Filter: "4.5_Hz_Duke_Malin_Seismometer",
						StageSet: PAZ{
							Name:  "MALIN_4.5",
							Code:  PZFunctionLaplaceRadiansPerSecond,
							Type:  "Laplace transform analog stage response, in rad/sec.",
							Notes: "derived from information passed on from Peter Malin <pem@asirseismic.com>",
							Poles: []complex128{(-60.822916536 + 71.994505702i), (-60.822916536 - 71.994505702i)},
							Zeros: []complex128{(0 + 0i), (0 + 0i)},
						},
						Frequency:  15,
						SampleRate: 0,
