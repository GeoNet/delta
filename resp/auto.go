	...
	Response{
		...
		Sensors: []Sensor{
			Sensor{
				...
				SensorList: []string{"Trillium Compact"},
				...
				FilterList: []string{"TRILLIUM-120PH-2"},
				Stages: []ResponseStage{
					ResponseStage{
						Type:   "paz",
						Lookup: "TRILLIUM-120PH-2",
						Filter: "TRILLIUM-120PH-2",
						StageSet: PAZ{
							Name:  "TRILLIUM-120PH-2",
							Code:  PZFunctionLaplaceRadiansPerSecond,
							Type:  "Laplace transform analog stage response, in rad/sec.",
		...
		Name: "Fresh Water Depth Sensors",
		Sensors: []Sensor{
			Sensor{
