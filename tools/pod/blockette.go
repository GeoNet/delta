...
var genericAbbreviations = []GenericAbbreviation{
	...
	{Code: 14, Description: "Lennartz Electronic LE-3Dlite"},
	{Code: 15, Description: "Canterbury Seismic Instruments CUSP3A SENSOR"},
	{Code: 16, Description: "Setra 270-600/24V"},
	{Code: 17, Description: "Canterbury Seismic Instruments CUSP3B SENSOR"},
	{Code: 18, Description: "Lennartz Electronic LE-3DliteMkII"},
	{Code: 19, Description: "GNS Science SDP"},
	{Code: 20, Description: "Geospace GS-11D seismometer"},
	{Code: 21, Description: "Canterbury Seismic Instruments CUSP3C SENSOR"},
